...
const FiltersBar = ({country, onCountryChange, onFavouritesChange, isFavourite, role, onRemoteChange, isRemote, remoteLabel, selectedItemsLabel, isFilterHidden }: IFiltersBarProps) => {
